...
async function main() {
  ...
  try {
    ...
    let doctor1 = await prisma.user.findFirst({
      where: { role: UserRole.DOCTOR, branchId: branch.id },
    });
    let doctor2: any = null;
    let receptionist = await prisma.user.findFirst({
      where: { role: UserRole.RECEPTION, branchId: branch.id },
    });
    let admin = await prisma.user.findFirst({
      where: { role: UserRole.ADMIN, branchId: branch.id },
    });
    ...
    if (userCount === 0) {
      ...
      console.log(
        'Created users: 1 Admin, 2 Doctors (Shravya, Praneeta), 1 Receptionist',
      );
    }
    ...
    if (roomCount === 0) {
      ...
      console.log(
        `Created ${rooms.length} rooms: 2 Consultation, 3 Procedure, 1 Telemedicine`,
      );
    }
      ...
      const visitHistoryData = [
        {
          ...
          presentIllness:
            'Patient reports itchy, red patches on both arms and legs that started 2 weeks ago. Symptoms worsen at night and with stress.',
          ...
          treatment: JSON.stringify({
            medications: [
              ...
              },
              {
                ...
                dosage: 'Apply liberally 3-4 times daily',
                duration: 'Ongoing',
              },
            ],
            procedures: [],
          ...
          notes:
            'Patient educated on proper skin care routine. Advised to return if symptoms worsen.',
          status: 'COMPLETED',
          visitNumber: 1,
        },
        {
          ...
          presentIllness:
            'Patient returns for follow-up of acne treatment started 6 weeks ago. Reports 70% improvement in facial acne.',
          vitals: JSON.stringify({
          ...
          treatment: JSON.stringify({
            medications: [
              {
                name: 'Continue Adapalene 0.1% Gel',
        ...
        },
        {
          ...
          presentIllness:
            'Patient concerned about a mole on left shoulder that has been changing in appearance over the past 3 months.',
          vitals: JSON.stringify({
          ...
          examination: JSON.stringify({
            ...
            dermatoscopy:
              'Benign features - symmetric pigment network, no atypical features',
          }),
            ...
            medications: [
              {
                ...
                dosage: 'As needed for procedure',
                duration: 'Single use',
              },
            ],
            procedures: [
              {
                name: 'Surgical excision of nevus',
                details: 'Complete excision with 2mm margins',
                completed: true,
              },
            ],
            lifestyle: [
              'Keep wound dry for 48 hours',
              'Return for suture removal in 1 week',
            ],
          }),
          followUpDate: new Date('2024-11-17T09:45:00'),
          notes:
            'Minor surgical excision completed successfully. Specimen sent for histopathology. Sutures to be removed in 7 days.',
          status: 'COMPLETED',
          visitNumber: 3,
        },
        {
          ...
          presentIllness:
            'Patient presents with moderate acne on face, predominantly inflammatory lesions. Previous OTC treatments have been ineffective.',
          vitals: JSON.stringify({
          ...
          notes:
            'Started on combination therapy. Patient counseled on expected timeline for improvement (6-8 weeks).',
          status: 'COMPLETED',
          visitNumber: 4,
        },
        {
          ...
          presentIllness:
            'Patient requests routine skin examination due to family history of melanoma in father. No specific concerns.',
          vitals: JSON.stringify({
            ...
            procedures: [
              {
                ...
                details: 'Comprehensive dermatoscopic evaluation',
                completed: true,
              },
            ],
            lifestyle: [
          ...
          notes:
            'Routine examination normal. Patient educated on skin cancer prevention and self-examination techniques.',
          status: 'COMPLETED',
          visitNumber: 5,
        },
      ];
      ...
      for (const visitData of visitHistoryData) {
        await prisma.visit.create({
          data: {
            ...
            doctorId: doctor1!.id, // Use the created doctor
            ...
            history: visitData.presentIllness
              ? JSON.stringify({ presentIllness: visitData.presentIllness })
              : null,
    ...
    const inventoryItems: Array<{
      ...
      {
        sku: 'MED-BPO-2.5-30G',
        name: 'Benzoyl Peroxide 2.5% Gel 30g',
        genericName: 'Benzoyl Peroxide',
        brandName: 'Brevoxyl/Panoxyl',
        type: InventoryItemType.MEDICINE,
        category: 'Acne',
      ...
      {
        sku: 'MED-CLINDAGEL-20G',
        name: 'Clindamycin 1% Gel 20g',
        ...
        gstRate: 12,
        currentStock: 50,
        tags: ['ACNE', 'ANTIBIOTIC'],
      },
      {
        sku: 'MED-TRETINOIN-20G',
        name: 'Tretinoin 0.05% Cream 20g',
      ...
      {
        sku: 'MED-SALICYLIC-60ML',
        name: 'Salicylic Acid 2% Face Wash 60ml',
        genericName: 'Salicylic Acid',
        brandName: 'Saslic/Saliface',
        type: InventoryItemType.MEDICINE,
        category: 'Acne',
        subCategory: 'Keratolytic',
      ...
      {
        sku: 'MED-ISOTRET-10MG',
        name: 'Isotretinoin 10 mg Capsules (Strip of 10)',
        genericName: 'Isotretinoin',
        brandName: 'Accufine/Isotroin',
        type: InventoryItemType.MEDICINE,
        category: 'Acne',
        subCategory: 'Systemic Retinoid',
      ...
      {
        sku: 'MED-ISOTRET-20MG',
        name: 'Isotretinoin 20 mg Capsules (Strip of 10)',
        genericName: 'Isotretinoin',
        brandName: 'Accufine/Isotroin',
        type: InventoryItemType.MEDICINE,
        category: 'Acne',
      ...
      {
        sku: 'MED-DOXY-100MG',
        name: 'Doxycycline 100 mg Tablets (Strip of 10)',
      ...
      {
        sku: 'MED-AZITHRO-500MG',
        name: 'Azithromycin 500 mg Tablets (Strip of 3)',
      ...
      {
        sku: 'MED-KETO-SHAM-100',
        name: 'Ketoconazole 2% Shampoo 100ml',
        ...
        gstRate: 18,
        currentStock: 40,
        tags: ['FUNGAL', 'DANDRUFF'],
      },
      {
        sku: 'MED-TERBI-250',
        name: 'Terbinafine 250 mg Tablets (Strip of 7)',
      ...
      {
        sku: 'MED-ITRA-100',
        name: 'Itraconazole 100 mg Capsules (Strip of 10)',
        genericName: 'Itraconazole',
        brandName: 'Itrasys/Candiforce',
        type: InventoryItemType.MEDICINE,
        category: 'Antifungal',
        subCategory: 'Oral',
        unit: UnitType.STRIPS,
      ...
      {
        sku: 'MED-MOME-15G',
        name: 'Mometasone 0.1% Cream 15g',
        genericName: 'Mometasone Furoate',
        brandName: 'Elocon/Momesone',
        type: InventoryItemType.MEDICINE,
        category: 'Steroid',
        subCategory: 'Topical',
        unit: UnitType.TUBES,
      ...
      {
        sku: 'MED-BETNOVATE-20G',
        name: 'Betamethasone Valerate 0.1% Cream 20g',
      ...
      {
        sku: 'MED-AZELAIC-20-15G',
        name: 'Azelaic Acid 20% Cream 15g',
      ...
      {
        sku: 'MED-KOJIC-30G',
        name: 'Kojic Acid Cream 30g',
        genericName: 'Kojic Acid + Vitamin C',
        brandName: 'Kojivit',
        type: InventoryItemType.MEDICINE,
        category: 'Pigmentation',
        subCategory: 'Topical',
      ...
      {
        sku: 'MED-CETIRIZINE-10',
        name: 'Cetirizine 10 mg Tablets (Strip of 10)',
      ...
      {
        sku: 'MED-LEVOCET-5',
        name: 'Levocetirizine 5 mg Tablets (Strip of 10)',
      ...
      {
        sku: 'MED-FEXO-180',
        name: 'Fexofenadine 180 mg Tablets (Strip of 10)',
      ...
      {
        sku: 'MED-CALBET-20G',
        name: 'Calcipotriol + Betamethasone Ointment 20g',
        genericName: 'Calcipotriol + Betamethasone',
        brandName: 'Tacroz Forte/Daivobet',
        type: InventoryItemType.MEDICINE,
        category: 'Psoriasis',
        subCategory: 'Combo',
        unit: UnitType.TUBES,
      ...
      {
        sku: 'MED-COALTAR-SHAM',
        name: 'Coal Tar + Salicylic Acid Shampoo 150ml',
      ...
      {
        sku: 'MED-MTX-2.5',
        name: 'Methotrexate 2.5 mg Tablets (Strip of 10)',
      ...
      {
        sku: 'MED-TAC-0.1-10G',
        name: 'Tacrolimus 0.1% Ointment 10g',
        genericName: 'Tacrolimus',
        brandName: 'Tacroz 0.1%',
        type: InventoryItemType.MEDICINE,
        category: 'Atopic/Vitiligo',
        subCategory: 'Topical Calcineurin Inhibitor',
        unit: UnitType.TUBES,
        packSize: 10,
        packUnit: 'g',
        costPrice: 280,
        ...
        gstRate: 12,
        currentStock: 28,
        tags: ['ATOPIC', 'VITILIGO'],
      },
      {
        sku: 'MED-TAC-0.03-10G',
        name: 'Tacrolimus 0.03% Ointment 10g',
        genericName: 'Tacrolimus',
        brandName: 'Tacroz 0.03%',
        type: InventoryItemType.MEDICINE,
        category: 'Atopic',
        subCategory: 'Topical Calcineurin Inhibitor',
        unit: UnitType.TUBES,
      ...
      // Hair loss
      {
        sku: 'MED-MINOX-5-60ML',
        name: 'Minoxidil 5% Solution 60ml',
        genericName: 'Minoxidil',
        brandName: 'Tugain/Rogaine',
        type: InventoryItemType.MEDICINE,
        category: 'Hair',
        subCategory: 'Topical',
        unit: UnitType.BOTTLES,
      ...
      {
        sku: 'MED-FINA-1MG',
        name: 'Finasteride 1 mg Tablets (Strip of 10)',
      ...
      {
        sku: 'MED-ACV-400',
        name: 'Acyclovir 400 mg Tablets (Strip of 10)',
      ...
      {
        sku: 'MED-ACV-CREAM-10G',
        name: 'Acyclovir 5% Cream 10g',
        genericName: 'Acyclovir',
        brandName: 'Acivir Cream',
        type: InventoryItemType.MEDICINE,
        category: 'Antiviral',
        subCategory: 'Topical',
        unit: UnitType.TUBES,
      ...
      {
        sku: 'MED-EMOLLIENT-50G',
        name: 'Light Liquid Paraffin + White Soft Paraffin Cream 50g',
        genericName: 'LLP + WSP',
        brandName: 'Moisturex',
        type: InventoryItemType.MEDICINE,
        category: 'Emollient',
      ...
      {
        sku: 'MED-UREA-10-100G',
        name: 'Urea 10% Cream 100g',
        genericName: 'Urea',
        brandName: 'Ureaderm',
        type: InventoryItemType.MEDICINE,
        category: 'Emollient',
      ...
      {
        sku: 'CONS-ALCO-SWABS-100',
        name: 'Alcohol Swabs (Pack of 100)',
        type: InventoryItemType.CONSUMABLE,
        category: 'Clinic',
      ...
      {
        sku: 'CONS-MICROPORE-1IN',
        name: 'Micropore Surgical Tape 1 inch x 9.1m',
        type: InventoryItemType.CONSUMABLE,
        category: 'Clinic',
        subCategory: 'Tape',
      ...
      {
        sku: 'CONS-NEEDLES-26G',
        name: 'Disposable Needles 26G (Box of 100)',
        type: InventoryItemType.CONSUMABLE,
        category: 'Clinic',
        subCategory: 'Needles',
        unit: UnitType.BOXES,
      ...
      {
        sku: 'EQP-COMEDONE-EXTRACT',
        name: 'Comedone Extractor (Stainless Steel)',
      ...
      {
        sku: 'EQP-DERMAROL-1.0',
        name: 'Dermaroller 1.0 mm',
        type: InventoryItemType.EQUIPMENT,
        category: 'Instruments',
        ...
        gstRate: 18,
        currentStock: 8,
        tags: ['INSTRUMENT', 'AESTHETIC'],
      },
      {
        sku: 'EQP-DERMAROL-0.5',
      ...
      {
        sku: 'EQP-BIOPSY-PUNCH-3',
        name: 'Skin Biopsy Punch 3 mm (Pack of 10)',
        type: InventoryItemType.EQUIPMENT,
        category: 'Instruments',
        subCategory: 'Biopsy',
        unit: UnitType.PACKS,
      ...
      {
        sku: 'EQP-CRYO-SPRAY',
        name: 'Cryo Spray (Liquid Nitrogen) - Refillable',
        type: InventoryItemType.EQUIPMENT,
        category: 'Instruments',
      ...
      {
        sku: 'EQP-CAUTERY-TIPS',
        name: 'Electrocautery Tips (Pack of 10)',
      ...
      {
        sku: 'MED-METRONIDAZOLE-20G',
        name: 'Metronidazole 1% Gel 20g',
      ...
      {
        sku: 'MED-CLINDABPO-15G',
        name: 'Clindamycin 1% + BPO 5% Gel 15g',
      ...
      {
        sku: 'MED-MUPI-5-5G',
        name: 'Mupirocin 2% Ointment 5g',
        genericName: 'Mupirocin',
        brandName: 'Bactroban/Mupi',
        type: InventoryItemType.MEDICINE,
        category: 'Bacterial',
        subCategory: 'Topical',
        unit: UnitType.TUBES,
      ...
      {
        sku: 'MED-SELEN-SEL-60',
        name: 'Selenium Sulfide 2.5% Shampoo 60ml',
      ...
      {
        sku: 'MED-ASCORBIC-20-30',
        name: 'Vitamin C 20% Serum 30ml',
      ...
      {
        sku: 'MED-HCQ-200',
        name: 'Hydroxychloroquine 200 mg Tablets (Strip of 10)',
      ...
      {
        sku: 'MED-CLTRIM-POW-75',
        name: 'Clotrimazole Dusting Powder 1% 75g',
        genericName: 'Clotrimazole',
      ...
      {
        sku: 'MED-GLYCOLIC-6-30',
        name: 'Glycolic Acid 6% Cream 30g',
        genericName: 'Glycolic Acid',
        brandName: 'Glyco 6',
        type: InventoryItemType.MEDICINE,
        category: 'Acne',
        subCategory: 'AHA',
      ...
      {
        sku: 'MED-CLOBET-0.05-25',
        name: 'Clobetasol Propionate 0.05% Cream 25g',
      ...
      {
        sku: 'MED-EMOL-SYLO-200',
        name: 'Syndet Moisturizing Lotion 200ml',
        genericName: 'Moisturizing Lotion',
        brandName: 'Cetaphil/Physiogel',
        type: InventoryItemType.MEDICINE,
        category: 'Emollient',
        subCategory: 'Lotion',
        unit: UnitType.BOTTLES,
      ...
      {
        sku: 'MED-ACNE-PATCH-24',
        name: 'Hydrocolloid Acne Patches (Pack of 24)',
        type: InventoryItemType.CONSUMABLE,
        category: 'Acne',
        subCategory: 'Patch',
        unit: UnitType.PACKS,
      ...
      {
        sku: 'MED-SILICONE-GEL-15',
        name: 'Silicone Scar Gel 15g',
        genericName: 'Silicone Gel',
        brandName: 'ScarRedu',
        type: InventoryItemType.MEDICINE,
        category: 'Scar',
        subCategory: 'Topical',
      ...
      {
        sku: 'MED-HCL-CHLORHEX-0.2',
        name: 'Chlorhexidine Mouthwash 0.2% 200ml',
      ...
      {
        sku: 'MED-RETINOL-0.3-30',
        name: 'Retinol 0.3% Serum 30ml',
        genericName: 'Retinol',
        brandName: 'Retinol Serum',
        type: InventoryItemType.MEDICINE,
        category: 'Antiaging',
        subCategory: 'Serum',
        unit: UnitType.BOTTLES,
      ...
      {
        sku: 'MED-LACTIC-12-100',
        name: 'Lactic Acid 12% Lotion 100ml',
      ...
      {
        sku: 'MED-UREA-20-50',
        name: 'Urea 20% Cream 50g',
        genericName: 'Urea',
        brandName: 'Ureaderm 20',
        type: InventoryItemType.MEDICINE,
        category: 'Emollient',
        subCategory: 'Keratolytic',
        unit: UnitType.TUBES,
      ...
      {
        sku: 'MED-COOL-ANTIF-15',
        name: 'Clotrimazole + Beclomethasone Cream 15g',
      ...
      {
        sku: 'MED-SALICYLIC-12-50',
        name: 'Salicylic Acid 12% Ointment 50g',
        genericName: 'Salicylic Acid',
        brandName: 'Salicylix',
        type: InventoryItemType.MEDICINE,
        category: 'Keratolytic',
      ...
      {
        sku: 'MED-GLUTATHIONE-600',
        name: 'Glutathione 600 mg Injection (Vial)',
      ...
      {
        sku: 'EQP-DERMA-PEN-TIPS',
        name: 'Dermapen Cartridges (Pack of 10)',
        type: InventoryItemType.SUPPLY,
        category: 'Instruments',
        subCategory: 'Microneedling',
        unit: UnitType.PACKS,
      ...
      {
        sku: 'CONS-PARAFFIN-GAUZE',
        name: 'Paraffin Gauze Dressing 10x10cm (Pack of 10)',
        type: InventoryItemType.CONSUMABLE,
        category: 'Clinic',
        subCategory: 'Dressings',
        unit: UnitType.PACKS,
      ...
      },
      {
        ...
        gstRate: 18,
        currentStock: 2,
        tags: ['INSTRUMENT', 'DIAGNOSTIC'],
      },
      {
        sku: 'EQP-DERMASCOPE',
        name: 'Dermatoscope (Handheld)',
        type: InventoryItemType.EQUIPMENT,
        category: 'Instruments',
        subCategory: 'Diagnostics',
        unit: UnitType.PIECES,
    ...
    const computeInvoiceTotal = (
      items: ReadonlyArray<{ qty: number; unitPrice: number; gstRate: number }>,
    ) => {
      ...
      const gstAmount = items.reduce(
        (sum, it) => sum + it.qty * it.unitPrice * (it.gstRate / 100),
        0,
      );
    ...
    const consultationSvc = await ensureService(
      'Dermatology Consultation',
      'Consult',
      500,
      0,
    );
    const moleExcisionSvc = await ensureService(
      'Mole Excision (Minor Procedure)',
      'Procedure',
      2500,
      18,
    );
    const acnePackageSvc = await ensureService(
      'Acne Treatment Package (8 weeks)',
      'Package',
      1200,
      18,
    );
    ...
    for (const visitRef of candidateVisits) {
      ...
      const existingForVisit = await prisma.invoice.findFirst({
        where: { visitId: visitRef.id },
      });
      ...
      const scenarios = [
        {
          ...
          items: [
            {
              serviceId: consultationSvc.id,
              name: consultationSvc.name,
              qty: 1,
              unitPrice: 500,
              gstRate: 0,
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              serviceId: moleExcisionSvc.id,
              name: moleExcisionSvc.name,
              qty: 1,
              unitPrice: 2500,
              gstRate: 18,
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              serviceId: acnePackageSvc.id,
              name: acnePackageSvc.name,
              qty: 1,
              unitPrice: 1200,
              gstRate: 18,
            },
      ...
      if (scenario.pay === 'FULL') {
        ...
        await prisma.invoice.update({
          where: { id: inv.id },
          data: { received: partial, balance: Math.max(total - partial, 0) },
        });
      }
