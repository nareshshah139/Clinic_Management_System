...
export type PurchasePermissions = { read: boolean; create: boolean; review: boolean; commit: boolean; automate: boolean; saveSupplier?: boolean; catalogDetails?: boolean; sourceHighlights?: boolean; editProduct?: boolean };
